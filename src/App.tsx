      ...
      <article>
        ...
        <div className="case-study-content">
          ...
          <Description header="The Interviews">
            ...
            <p>For instance, all of our interview subjects stated that they shopped at CVS at least once a week. They also affirmed that using the self-checkout was their first instinct when making purchases. Users commented that they used the self-checkout by default as they either:</p>
            <ul>
              <li>didn't want to interact with the cashier</li>
              <li>wanted to quickly go in an out of the store</li>
            </ul>
            <p>Interestingly, one customer commented that they often bought intimate products at CVS, so using the cashier felt like an invasion of privacy.</p>
            <p>Most interview subjects also stated that the self-checkout interface was easy to learn.</p>
            <p>An interesting point of contention occurred when asking users whether the self-checkout interface was efficient. Many customers stated that when comparing the interface with a cashier, the interface was more efficient. However, when comparing the interface with other digital applications, they commented that it could be more efficient.</p> 
            <p>Many users lamented the time delay between interactions.</p> 
            <p>One user was especially frustrated with the amount of taps necessary to get to the payment screen.</p>
          </Description>
          <Splitshow>
